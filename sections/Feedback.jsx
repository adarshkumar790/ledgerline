...
const Feedback = () => (
    <section className={ `${ styles.paddings } relative z-10` }>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
              "With the development of today's technology, vr / ar / metaverse is very useful for introducing today's generation to the vastness of our religious and cultural heritage."
            </p>
          </div>
        </motion.div>
        ...
        >
          <img
            src="assets/arvr1.png"
            alt="Man and a woman watching VR"
